...
4. If it recommends `Set Audio Lead`, use the suggested lead_s range.
   If it recommends `Set Audio Trail`, use the suggested trail_s range.
5. Use `apply_edl` to commit the split edit.

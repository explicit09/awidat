...
These are not normal development or CI checks. Some use large fixtures, model weights, isolated workspaces, or repeated samples. See [Performance Benchmarks](docs/performance-benchmarks.md) for prerequisites, smoke commands, evidence requirements, and result-validation rules.

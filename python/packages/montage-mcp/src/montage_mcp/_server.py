...
- Stdio transport selection (the only one Montage uses today).
...
Example:
    ...
    from montage_mcp import IndexerServer, Sidecar
...
from montage_mcp._sidecar import Sidecar
...
class IndexAssetRequest(BaseModel):
    ...
    """Absolute Montage project root where sidecars and manifest live."""

"""Shared library for Montage MCP indexers.
...
read the code. With it, "add a new signal" is "import montage_mcp, write
the body of `index_asset`."
"""

from montage_mcp._sidecar import Sidecar, SidecarHeader
from montage_mcp._sha import asset_sha256
from montage_mcp._server import IndexerServer, IndexAssetRequest

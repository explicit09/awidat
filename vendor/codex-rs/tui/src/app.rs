...
See the Codex keymap documentation for supported actions and examples."
    ...
    fn render_chat_widget_frame(
        ...
        // Closure capturing the split + render logic so it's identical
        // in both the resize-reflow and non-reflow branches.
        // Closure isn't shared between branches because both `tui.draw`

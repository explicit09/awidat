...
//!
//! The MCP port constructs an ad-hoc `montage_render::JobManager` per
...
pub async fn run(args: ExportPackageArgs, ctx: McpToolCtx) -> Result<String, String> {
    ...
    let job_manager = montage_render::JobManager::new();
...
pub fn collect_timeline_cues(project_root: &Path, project: &Project) -> Result<Vec<Cue>, String> {
...
fn render_err(e: montage_render::RenderTimelineError) -> String {

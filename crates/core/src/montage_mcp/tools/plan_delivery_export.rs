...
//!
//! Resolves a human delivery intent to an existing Montage render/export path.
//! It does not mutate the project or start work; it returns the concrete tools
//! an agent should call next.

use montage_proto::professional::{ExportPreset, HardwareAccelerationPolicy};
...
fn package_preset(format: &str) -> ExportPreset {
    match format {
        ...
        _ => {
            let profile = montage_proto::professional::DeliveryProfile::youtube_1080p();
            ...
            ExportPreset {
                ...
                mode: montage_proto::professional::ExportMode::AudioVideo,
                profile,
                output: montage_proto::professional::ExportOutputSettings {
                    hardware_acceleration: HardwareAccelerationPolicy::Off,
                    ..montage_proto::professional::ExportOutputSettings::mp4()
                },
                video: Some(montage_proto::professional::VideoExportSettings::h264(
                    bitrate_kbps,
                )),
                audio: Some(montage_proto::professional::AudioExportSettings::aac(192)),

...
fn push_script_info(out: &mut String, canvas: RenderCanvas) {
    ...
    out.push_str("; Generated by montage-render libass caption path\n");
...
/// caller wants. Documented as `MONTAGE_CAPTION_FONT` for users.
const CAPTION_FONT_ENV: &str = "MONTAGE_CAPTION_FONT";
...
/// reads `MONTAGE_CAPTION_FONT` from the real process env.
